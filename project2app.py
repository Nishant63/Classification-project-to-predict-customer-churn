...
nav = st.sidebar.selectbox("select Below",["Predict Churn","EDA"])


if nav == "Predict Churn":
    
    st.image("https://cdn.dribbble.com/users/3167791/screenshots/7195669/media/de1a7d75b3d1b8d2be59eddd802432e0.jpg?compress=1&resize=768x576&vertical=top",width=400)
